package com.coffeebean.swf.typeData {
	...
	public dynamic final class SpriteData extends com.netease.protobuf.Message {
		 ...
		 *  @private
		 */
		public static const ALPHA:FieldDescriptor$TYPE_FLOAT = new FieldDescriptor$TYPE_FLOAT("com.coffeebean.swf.typeData.SpriteData.alpha", "alpha", (200012 << 3) | com.netease.protobuf.WireType.FIXED_32_BIT);
		 ...
		 *  @private
		 */
		public static const INDEX:FieldDescriptor$TYPE_INT32 = new FieldDescriptor$TYPE_INT32("com.coffeebean.swf.typeData.SpriteData.index", "index", (200013 << 3) | com.netease.protobuf.WireType.VARINT);
		 ...
		 *  @private
		 */
		public static const WIDTH:FieldDescriptor$TYPE_INT32 = new FieldDescriptor$TYPE_INT32("com.coffeebean.swf.typeData.SpriteData.width", "width", (200014 << 3) | com.netease.protobuf.WireType.VARINT);
		 ...
		 *  @private
		 */
		public static const HEIGHT:FieldDescriptor$TYPE_INT32 = new FieldDescriptor$TYPE_INT32("com.coffeebean.swf.typeData.SpriteData.height", "height", (200015 << 3) | com.netease.protobuf.WireType.VARINT);
		 ...
		 *  @private
		 */
		public static const FONT:FieldDescriptor$TYPE_STRING = new FieldDescriptor$TYPE_STRING("com.coffeebean.swf.typeData.SpriteData.font", "font", (200016 << 3) | com.netease.protobuf.WireType.LENGTH_DELIMITED);
		 ...
		 *  @private
		 */
		public static const COLOR:FieldDescriptor$TYPE_UINT32 = new FieldDescriptor$TYPE_UINT32("com.coffeebean.swf.typeData.SpriteData.color", "color", (200017 << 3) | com.netease.protobuf.WireType.VARINT);
		 ...
		 *  @private
		 */
		public static const SIZE:FieldDescriptor$TYPE_INT32 = new FieldDescriptor$TYPE_INT32("com.coffeebean.swf.typeData.SpriteData.size", "size", (200018 << 3) | com.netease.protobuf.WireType.VARINT);
		 ...
		 *  @private
		 */
		public static const ALIGN:FieldDescriptor$TYPE_STRING = new FieldDescriptor$TYPE_STRING("com.coffeebean.swf.typeData.SpriteData.align", "align", (200019 << 3) | com.netease.protobuf.WireType.LENGTH_DELIMITED);
		 ...
		 *  @private
		 */
		public static const ITALIC:FieldDescriptor$TYPE_BOOL = new FieldDescriptor$TYPE_BOOL("com.coffeebean.swf.typeData.SpriteData.italic", "italic", (200020 << 3) | com.netease.protobuf.WireType.VARINT);
		 ...
		 *  @private
		 */
		public static const BOLD:FieldDescriptor$TYPE_BOOL = new FieldDescriptor$TYPE_BOOL("com.coffeebean.swf.typeData.SpriteData.bold", "bold", (200021 << 3) | com.netease.protobuf.WireType.VARINT);
		 ...
		 *  @private
		 */
		public static const TEXT:FieldDescriptor$TYPE_STRING = new FieldDescriptor$TYPE_STRING("com.coffeebean.swf.typeData.SpriteData.text", "text", (200022 << 3) | com.netease.protobuf.WireType.LENGTH_DELIMITED);
		 ...
		 *  @private
		 */
		public static const COMPDATA:FieldDescriptor$TYPE_STRING = new FieldDescriptor$TYPE_STRING("com.coffeebean.swf.typeData.SpriteData.compData", "compData", (200023 << 3) | com.netease.protobuf.WireType.LENGTH_DELIMITED);
		...
		override com.netease.protobuf.used_by_generated_code final function writeToBuffer(output:com.netease.protobuf.WritingBuffer):void {
			...
			if (hasAlpha) {
				com.netease.protobuf.WriteUtils.writeTag(output, com.netease.protobuf.WireType.FIXED_32_BIT, 200012);
			...
			if (hasWidth) {
				com.netease.protobuf.WriteUtils.writeTag(output, com.netease.protobuf.WireType.VARINT, 200014);
			...
			if (hasFont) {
				com.netease.protobuf.WriteUtils.writeTag(output, com.netease.protobuf.WireType.LENGTH_DELIMITED, 200016);
				com.netease.protobuf.WriteUtils.write$TYPE_STRING(output, font$field);
			}
			if (hasColor) {
				com.netease.protobuf.WriteUtils.writeTag(output, com.netease.protobuf.WireType.VARINT, 200017);
			...
			if (hasAlign) {
				com.netease.protobuf.WriteUtils.writeTag(output, com.netease.protobuf.WireType.LENGTH_DELIMITED, 200019);
				com.netease.protobuf.WriteUtils.write$TYPE_STRING(output, align$field);
			}
			if (hasItalic) {
				com.netease.protobuf.WriteUtils.writeTag(output, com.netease.protobuf.WireType.VARINT, 200020);
				com.netease.protobuf.WriteUtils.write$TYPE_BOOL(output, italic$field);
			}
			if (hasBold) {
				com.netease.protobuf.WriteUtils.writeTag(output, com.netease.protobuf.WireType.VARINT, 200021);
				com.netease.protobuf.WriteUtils.write$TYPE_BOOL(output, bold$field);
			}
			if (hasText) {
				com.netease.protobuf.WriteUtils.writeTag(output, com.netease.protobuf.WireType.LENGTH_DELIMITED, 200022);
				com.netease.protobuf.WriteUtils.write$TYPE_STRING(output, text$field);
			}
			if (hasCompData) {
				com.netease.protobuf.WriteUtils.writeTag(output, com.netease.protobuf.WireType.LENGTH_DELIMITED, 200023);
