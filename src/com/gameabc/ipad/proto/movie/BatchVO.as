package com.gameabc.ipad.proto.movie {
	...
	public dynamic final class BatchVO extends com.netease.protobuf.Message {
		 ...
		 *  @private
		 */
		public static const SCALE:FieldDescriptor$TYPE_FLOAT = new FieldDescriptor$TYPE_FLOAT("com.gameabc.ipad.proto.movie.BatchVO.scale", "scale", (3 << 3) | com.netease.protobuf.WireType.FIXED_32_BIT);
		 ...
		 *  @private
		 */
		public static const IMAGENAMES:RepeatedFieldDescriptor$TYPE_STRING = new RepeatedFieldDescriptor$TYPE_STRING("com.gameabc.ipad.proto.movie.BatchVO.imageNames", "imageNames", (7 << 3) | com.netease.protobuf.WireType.LENGTH_DELIMITED);
		...
		override com.netease.protobuf.used_by_generated_code final function writeToBuffer(output:com.netease.protobuf.WritingBuffer):void {
			...
			if (hasScale) {
				...
				com.netease.protobuf.WriteUtils.write$TYPE_FLOAT(output, scale$field);
			}
			if (hasMyParamsType) {
		...
		override com.netease.protobuf.used_by_generated_code final function readFromSlice(input:flash.utils.IDataInput, bytesAfterSlice:uint):void {
			...
			while (input.bytesAvailable > bytesAfterSlice) {
				...
				case 3:
					...
					++scale$count;
					this.scale = com.netease.protobuf.ReadUtils.read$TYPE_FLOAT(input);
					break;
				case 4:
